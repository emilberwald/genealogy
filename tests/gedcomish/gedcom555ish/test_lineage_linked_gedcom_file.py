...
class TestExampleFiles:
    def test_minimal555(self):
        ...
        minimal555.HEAD = GEDCOM_HEADER.HEAD()
        minimal555.HEAD.GEDC = GEDCOM_HEADER.HEAD.GEDC()
        minimal555.HEAD.GEDC.VERS = GEDCOM_HEADER.HEAD.GEDC.VERS("5.5.5")
        minimal555.HEAD.GEDC.FORM = GEDCOM_HEADER.HEAD.GEDC.FORM("LINEAGE-LINKED")
        minimal555.HEAD.GEDC.FORM.VERS = GEDCOM_HEADER.HEAD.GEDC.FORM.VERS("5.5.5")
        minimal555.HEAD.CHAR = GEDCOM_HEADER.HEAD.CHAR("UTF-8")
        minimal555.GEDCOM_FORM_HEADER_EXTENSION = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION()
        minimal555.GEDCOM_FORM_HEADER_EXTENSION.SOUR = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.SOUR(
            "gedcom.org"
        )
        ...
        minimal555.TRLR = GEDCOM_TRAILER.TRLR()
        lines = GEDCOM_LINES()
    ...
    def test_555sample(self):
        ...
        ex.HEAD = GEDCOM_HEADER.HEAD()
        ex.HEAD.GEDC = GEDCOM_HEADER.HEAD.GEDC()
        ex.HEAD.GEDC.VERS = GEDCOM_HEADER.HEAD.GEDC.VERS("5.5.5")
        ex.HEAD.GEDC.FORM = GEDCOM_HEADER.HEAD.GEDC.FORM("LINEAGE-LINKED")
        ex.HEAD.GEDC.FORM.VERS = GEDCOM_HEADER.HEAD.GEDC.FORM.VERS("5.5.5")
        ex.HEAD.CHAR = GEDCOM_HEADER.HEAD.CHAR("UTF-8")
        ex.GEDCOM_FORM_HEADER_EXTENSION = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION()
        ex.GEDCOM_FORM_HEADER_EXTENSION.SOUR = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.SOUR("GS")
        ex.GEDCOM_FORM_HEADER_EXTENSION.SOUR.NAME = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.SOUR.NAME(
            "GEDCOM Specification"
        )
        ex.GEDCOM_FORM_HEADER_EXTENSION.SOUR.VERS = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.SOUR.VERS(
            "5.5.5"
        )
        ex.GEDCOM_FORM_HEADER_EXTENSION.SOUR.CORP = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.SOUR.CORP(
            "gedcom.org"
        )
        ...
        ex.GEDCOM_FORM_HEADER_EXTENSION.DATE = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.DATE(
            "2 Oct 2019"
        )
        ex.GEDCOM_FORM_HEADER_EXTENSION.DATE.TIME = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.DATE.TIME(
            "0:00:00"
        )
        ex.GEDCOM_FORM_HEADER_EXTENSION.FILE = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.FILE(
            "555Sample.ged"
        )
        ex.GEDCOM_FORM_HEADER_EXTENSION.LANG = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.LANG(
            "English"
        )
        ex.GEDCOM_FORM_HEADER_EXTENSION.SUBM = GEDCOM_FORM_HEADER_EXTENSION.LINEAGE_LINKED_HEADER_EXTENSION.SUBM("U1")
