...
class TestGenerateFull:
    def test_prepare_check_in_gedcom_validator(self):
        ...
        ex.GEDCOM_HEADER.HEAD = GEDCOM_HEADER.HEAD()
        ex.GEDCOM_HEADER.HEAD.GEDC = GEDCOM_HEADER.HEAD.GEDC()
        ex.GEDCOM_HEADER.HEAD.GEDC.VERS = GEDCOM_HEADER.HEAD.GEDC.VERS("GEDCOM_VERSION_NUMBER")
        ex.GEDCOM_HEADER.HEAD.GEDC.FORM = GEDCOM_HEADER.HEAD.GEDC.FORM("LINEAGE-LINKED")
        ex.GEDCOM_HEADER.HEAD.GEDC.FORM.VERS = GEDCOM_HEADER.HEAD.GEDC.FORM.VERS("GEDCOM_VERSION_NUMBER")
        ex.GEDCOM_HEADER.HEAD.CHAR = GEDCOM_HEADER.HEAD.CHAR("CHARACTER_ENCODING")
