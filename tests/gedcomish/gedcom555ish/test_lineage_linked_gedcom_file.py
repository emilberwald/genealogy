...
class TestExampleFiles:
    ...
    def test_555sample(self):
        ...
        ex.FORM_RECORDS.SUBMITTER_RECORD.SUBM.NAME = SUBMITTER_RECORD.SUBM.NAME("Reoldon Poulson")
        ...
        ex.FORM_RECORDS.SUBMITTER_RECORD.SUBM.ADDRESS_STRUCTURE.ADDR.STAE = ADDRESS_STRUCTURE.ADDR.CITY("Montana")
        ex.FORM_RECORDS.SUBMITTER_RECORD.SUBM.ADDRESS_STRUCTURE.ADDR.POST = ADDRESS_STRUCTURE.ADDR.POST("68051")
        ex.FORM_RECORDS.SUBMITTER_RECORD.SUBM.ADDRESS_STRUCTURE.ADDR.CTRY = ADDRESS_STRUCTURE.ADDR.POST(
